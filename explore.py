...
def explore_univariate(train, cat_vars, quant_vars): ###CORRECT## 
    for var in cat_vars:
...
def explore_univariate_categorical(train, cat_var): ###CORRECT## 
    '''
...
def explore_univariate_quant(train, quant_var): ###CORRECT## 
    '''
...
def freq_table(train, cat_var): ###CORRECT## 
    '''
